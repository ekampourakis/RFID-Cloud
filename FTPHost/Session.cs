...
namespace mooftpserv
{
    ...
    class Session
    {
        ...
        /// </summary>
        public Session(Socket socket, int bufferSize, IAuthHandler authHandler, IFileSystemHandler fileSystemHandler, ILogHandler logHandler, string password)
        {
        ...
        private void Work()
        {
            ...
            try {
                ...
                // allow anonymous login? uncomment to enable
        ...
        private void HandleAuth(string verb, string args)
        {
            if (verb == "USER" && args != null) {
                if (authHandler.AllowLogin(args, null, password)) {
                ...
                if (loggedInUser != null) {
                    if (authHandler.AllowLogin(loggedInUser, args, password)) {
                        Respond(230, "Login successful.");
                        loggedIn = true;
                    } else {
                        loggedInUser = null;
